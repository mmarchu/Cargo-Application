...
public class RegisterActivity extends AppCompatActivity {
    ...
    private String URL = "http://10.0.2.2:80/pjmobile/register.php";
    private String name, username, password, reenterPassword;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        name = username = password = reenterPassword = "";
    }
            ...
            StringRequest stringRequest = new StringRequest(Request.Method.POST, URL, new Response.Listener<String>() {
                ...
                public void onResponse(String response) {
                    if (response.equals("success")) {
                        ...
                        Toast.makeText(RegisterActivity.this, "Something was wrong", Toast.LENGTH_SHORT);                    }
                }
